    ...
    <div class="container d-flex justify-content-center">
        <div class="card bg-light w-75 my-4">
            <div class="card-body "><br>
                ...
                <form method="POST" class="container my-5" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?id='.$_GET['id'].'&id_provinsi='.$_GET['id_provinsi']; ?>" enctype="multipart/form-data">
